...
<html lang="zh-CN">
  <head>
    ...
    <link href="<?php echo get_assets_url('css_mainsite');?>" rel="stylesheet">
        ...
        <div id="navbar" class="container">
            <nav class="navbar" role="navigation">
               <div class="navbar-header">
                  <a class="navbar-brand" href="/"><img src="<?php echo get_assets_url('img_logo');?>" title="网站LOGO" style="height:60px"/></a>
               </div>
        ...
        <div id="carousel" class="carousel slide">
          ...
          <div class="carousel-inner">
              <div class="item active">
                 <a href=""><img src="http://website.com/Public/upload/img/0.jpg" style="height:330px;"></a> <!-- 400 X 240 (mobile) 2580 X 330 (pc) -->
              </div>
              <div class="item">
                 <a href=""><img src="http://website.com/Public/upload/img/1.jpg" style="height:330px;"></a>
              </div>
              <div class="item">
                 <a href=""><img src="http://website.com/Public/upload/img/2.jpg" style="height:330px;"></a>
              </div>
          </div>
...
<div class="container-fluid service-project">
<div class="container">
    <div class="row"><p class="perfect-circle red-white">B</p></div>
    <div class="row"><p class="title-zh color-red">中国企业培训第一品牌</p></div>
    <div class="row"><p class="title-en color-gray">BRAND COURSE</p></div>
    <div class="row">T</div>
</div>
</div>    

<div class="container-fluid good-case">
<div class="container">
    <div class="row"><p class="perfect-circle white-red">B</p></div>
    <div class="row"><p class="title-zh color-white">中国企业培训第一品牌</p></div>
    <div class="row"><p class="title-en color-white">BRAND COURSE</p></div>
    <div class="row">T</div>
</div>
</div>    

<div class="container-fluid recom-teacher">
<div class="container">
    <div class="row"><p class="perfect-circle red-white">B</p></div>
    <div class="row"><p class="title-zh color-red">中国企业培训第一品牌</p></div>
    <div class="row"><p class="title-en color-gray">BRAND COURSE</p></div>
...
<div class="container-fluid coop-partner">
<div class="container">
    <div class="row"><p class="perfect-circle white-red">B</p></div>
    <div class="row"><p class="title-zh color-white">中国企业培训第一品牌</p></div>
    <div class="row"><p class="title-en color-white">BRAND COURSE</p></div>
...
<div class="container-fluid service-line">
<div class="container">
    <div class="row"><p class="perfect-circle black-white">B</p></div>
    <div class="row"><p class="title-zh color-white">中国企业培训第一品牌</p></div>
    <div class="row"><p class="title-en color-white">BRAND COURSE</p></div>
    <div class="row">T</div>
</div>
            ...
            <div class="container">
                <div class="col-xs-8">
                   <div class="col-xs-3">
                        ...
                        <p><a class="page-link"  href="">服务项目</a></p>
                  ...
                  <div class="col-xs-4">
                    <div>
                        <p class="weichat">微信公众号</p>
                        <p><img src="<?php echo get_assets_url('img_bar');?>"/></p>
                    </div>
                  </div>
            </div>    
        </div>
