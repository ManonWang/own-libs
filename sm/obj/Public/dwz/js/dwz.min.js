...
if(json[DWZ.keys.message])alertMsg.error(msg);}else{
$this.html(response).initUI();
if($.isFunction(op.callback))op.callback(response);}
if(json[DWZ.keys.statusCode]==DWZ.statusCode.timeout){
if($.pdialog)$.pdialog.checkTimeout();
if(navTab)navTab.checkTimeout();
alertMsg.error(msg||DWZ.msg("sessionTimout"),{okCall:function(){
DWZ.loadLogin();}});}},
error:DWZ.ajaxError,
statusCode:{
...
var dataText=$table.attr('data')||"Add New";
if(addButTxt){
var $addBut=$('<div class="button"><div class="buttonContent"><button type="button" data="'+dataText+'">'+addButTxt+'</button></div></div>').insertBefore($table).find("button");
