...
<table class="table table-bordered form-table">
                    ...
                    <div class="typeahead__container">
                     <div class="typeahead__field">
                       <span class="typeahead__query">
                        ...
                        <input type="hidden" name="fix_user_id" data="value" action="/staff/department" value="<?php echo ($data['resp_user_id']); ?>"/>
                       </span>
                    </div>
                </div>
           </tr>
                ...
                <td>
                    <div class="typeahead__container">
                     <div class="typeahead__field">
                       <span class="typeahead__query">
                        <input type="text" class="js-typeahead form-control" style="width: 100%!important;" autocomplete="off" 
                        value="<?php echo ($staff[$data['fix_user_id']]['salary_id']); ?> | <?php echo ($staff[$data['fix_user_id']]['name']); ?> | <?php echo ($staff[$data['fix_user_id']]['work_id']); ?>"/>
                        <input type="hidden" name="fix_user_id" value="<?php echo ($data['fix_user_id']); ?>"/>
                       </span>
                    </div>
                </div>
           </tr>
    ...
    <tr>
        ...
        <td class="td-ctr-line" colspan="3">
            <textarea class="form-control" rows="3" cols="100" name="risk_reason" id="risk_outline"><?php echo ($data['risk_reason']); ?></textarea>
        </td>
    </tr>
    <tr>
        <td class="feild-title">落实情况</td>
        <td class="td-ctr-line" colspan="3">
            <textarea class="form-control" rows="3" cols="100" name="risk_fix" id="risk_outline"><?php echo ($data['risk_fix']); ?></textarea>
        </td>
    </tr>
</table>
