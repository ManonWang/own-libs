...
<table class="table table-striped table-bordered table-hover">
  ...
  <tbody>
    <?php if(is_array($result)): foreach($result as $key=>$item): ?><tr class="data-row" data-id="<?php echo ($item['id']); ?>">
        ...
        <td>
            <a href="/handle/trackShow.html?id=<?php echo ($item['id']); ?>">编辑</a> &nbsp;
            <a href="javascript:void(0);" class="del" action="/handle/trackDel"  data="id=<?php echo ($item['id']); ?>">删除</a>
        </td>
