   ...
   <form id="query-form" class="form-inline">
        <div class="form-group">
           ...
           <select name="track_dept[]" class="form-control" id="track_dept" multiple="multiple">
              ...
              <?php if(is_array($dicLists[$allTypes['department']])): foreach($dicLists[$allTypes['department']] as $key=>$item): ?><option value="<?php echo ($item['id']); ?>" <?php if(in_array($item['id'], $track_dept)): ?>selected="selected"<?php endif; ?>>
                    <?php echo ($item['name']); ?>
...
<table class="table table-striped table-bordered table-hover">
  ...
  <tbody>
    <?php if(is_array($pagedList['data_list'])): foreach($pagedList['data_list'] as $key=>$item): ?><tr class="data-row" data-id="<?php echo ($item['id']); ?>">
        <td><?php echo date('Y-m-d', strtotime($item['track_time']));?></td>
        <td><?php echo ($dicLists[$allTypes['track_type']][$item['track_type']]['name']); ?></td>
        <td><?php echo ($dicLists[$allTypes['department']][$item['track_dept']]['name']); ?></td>
        <td><?php echo ($item['content']); ?></td>
        <td>
            <?php if('' != $item['access_url']): ?><a href="<?php echo ($item['access_url']); ?>">附件下载</a><?php endif; ?>
        </td>
