    ...
    <tr>
        ...
        <td>
            <select name="track_type" class="form-control">
              <?php if(is_array($dicLists[$allTypes['track_type']])): foreach($dicLists[$allTypes['track_type']] as $key=>$item): ?><option value="<?php echo ($item['id']); ?>"><?php echo ($item['name']); ?></option><?php endforeach; endif; ?>
            </select>
        </td>
    </tr>
    <tr>
...
<div class="text-center">
    ...
    <input type="botton" value="新增" class="btn btn-primary action-btn"  action="/handle/trackSave"  jump-url="/handle/track.html"/>
</div>
</form>
