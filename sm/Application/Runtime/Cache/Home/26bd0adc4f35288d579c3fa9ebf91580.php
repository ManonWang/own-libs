...
<table class="table table-striped table-bordered table-hover">
  <thead>
    <tr>
        ...
        <th>落实时限</th>
        <th>落实部门</th>
        <th>操作 <a href="/analyse/superviseAdd.html">[新增预警]</a></th>
    </tr>
  </thead>
  <tbody>
    <?php if(is_array($pagedList['data_list'])): foreach($pagedList['data_list'] as $key=>$item): ?><tr>
        ...
        <td><?php echo ($item['alarm_time']); ?></td>
        <td><?php echo ($item['fix_time']); ?></td>
        <td><?php echo ($item['fix_dept_cn']); ?></td>
        <td>
            <?php if(1 == $item['fix_status']): ?><a href="javascript:void(0);" data="id=<?php echo ($item['id']); ?>" class="fix_status" action="/analyse/chgFixStatus" >落实</a> &nbsp;&nbsp;&nbsp;<?php endif; ?>
            <a href="/analyse/superviseAdd.html?id=<?php echo ($item['id']); ?>">详细</a> 
        </td>
