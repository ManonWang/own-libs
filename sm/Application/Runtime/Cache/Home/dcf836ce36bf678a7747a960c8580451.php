  ...
  <form id="query-form" class="form-inline">
    <div class="form-group">
       ...
       <select class="form-control" name="timeYear"> 
        <?php $__FOR_START_491751758__=date('Y');$__FOR_END_491751758__=date('Y') - 30;for($index=$__FOR_START_491751758__;$index > $__FOR_END_491751758__;$index+=-1){ ?><option value="<?php echo ($index); ?>" <?php if($index == $timeYear): ?>selected="selected"<?php endif; ?> ><?php echo ($index); ?></option><?php } ?>
       </select>
       年
       <select class="form-control" name="timeMonth"> 
        <option value="">选择月</option>
        <?php $__FOR_START_764652555__=1;$__FOR_END_764652555__=13;for($index=$__FOR_START_764652555__;$index < $__FOR_END_764652555__;$index+=1){ ?><option value="<?php echo ($index); ?>" <?php if($index == $timeMonth): ?>selected="selected"<?php endif; ?> ><?php echo sprintf('%02d', $index);?></option><?php } ?>
       </select>
       月
    </div>
    <div class="form-group">
...
<p class="page-title">机车质量跟踪系统-JT6分析</p>
