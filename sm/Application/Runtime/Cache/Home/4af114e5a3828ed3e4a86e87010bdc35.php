...
<div id="breadcrumb">
 <ol class="breadcrumb">
  ...
  <li class="active">风险办审核风险信息列表</li>
 </ol>    
</div>

<p class="page-title">风险办审核风险信息列表</p>
<table class="table table-striped table-bordered table-hover">
  ...
  <tbody>
    <?php if(is_array($pagedList['data_list'])): foreach($pagedList['data_list'] as $key=>$item): ?><tr>
        ...
        <td style="width:100px;"><?php echo date("Y-m-d H:i:s", $item['create_time']);?></td>
        <td style="width:100px;"><?php echo ($dicLists[$allTypes['risk_type']][$item['risk_type']]['name']); ?></td>
        <td style="width:100px;"><?php echo ($dicLists[$allTypes['risk_level']][$item['risk_level']]['name']); ?></td>
        <td><?php echo ($dicLists[$allTypes['risk_item']][$item['risk_outline_id']]['name']); ?></td>
        <td style="width:80px">
            <a href="/handle/aduitShow.html?id=<?php echo ($item['id']); ?>">进入审核</a> 
        </td>
