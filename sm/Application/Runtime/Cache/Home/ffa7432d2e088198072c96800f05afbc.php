  ...
  <body>
    ...
    <div class="analyse_div"> 
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
            <?php $__FOR_START_1681476232__=0;$__FOR_END_1681476232__=24;for($time=$__FOR_START_1681476232__;$time < $__FOR_END_1681476232__;$time+=1){ ?><tr>
                    <td><?php echo ($time); ?>时</td>
                    <?php if(is_array($levelData)): foreach($levelData as $levelKey=>$levelItem): ?><td>
                            <?php echo ($data[$time][$levelItem['id']]); ?>
                            <?php $colStat[$levelKey] = $colStat[$levelKey] + $data[$time][$levelItem['id']]; ?>
                        </td><?php endforeach; endif; ?>
                    <td><?php echo array_sum($data[$time]);?></td>
                </tr><?php } ?>
            <tr>
                <td>合计</td>
